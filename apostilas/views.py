...
def adicionar_apostilas(request):
    if request.method == 'GET':
        ...
        view_totas = ViewApostila.objects.filter(apostila__user=request.user).count()

        return render(request, 'adicionar_apostilas.html',{'apostilas':apostilas,'view_totas':view_totas})
